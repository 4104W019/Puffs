	...
	<div id="Config_Page">
		<div id="Config_MainMenu">
			<table id="tabMainMenu" cellspacing="0" cellPadding="0" border="0">
                <tr>
                    <td>
                        <div class="TitleBar"><div class="Text_Over_Image">產品</div> </div>
                    </td>
                </tr>
                <tr onclick="ChangeItem(1)">
                    <td>
                        ...
                        <div id="mtext1" class="SubText_Over_Image" style="padding-top: 5px">泡芙單點</div> </div>
                    </td>
                </tr>
                <tr onclick="ChangeItem(2)">
                    <td>
                        ...
                        <div id="mtext2" class="SubText_Over_Image" style="padding-top: 5px">廠商資訊</div> </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="TitleBar"><div class="Text_Over_Image">訂單</div> </div>
                    </td>
                </tr>
                <tr onclick="ChangeItem(3)">
                    <td>
                        ...
                        <div id="mtext3" class="SubText_Over_Image" style="padding-top: 5px">訂單</div> </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="TitleBar"><div class="Text_Over_Image">員工</div> </div>
                    </td>
                </tr>
                <tr onclick="ChangeItem(4)">
                    <td>
                        ...
                        <div id="mtext4" class="SubText_Over_Image" style="padding-top: 5px">員工</div> </div>
                    </td>
                </tr>
                <tr>
                    <td>
